...
export function PinnedSection({ scope }: { scope: string }) {
  ...
  return (
    <section className="mb-5 border-b pb-5" aria-label="Pinned notes">
...
export function UnpinnedHeading({ scope }: { scope: string }) {
  ...
  return (
    <div className="mb-3 flex items-center gap-2 px-1" aria-hidden>
      <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">Unpinned</h2>
    </div>
  );
}
